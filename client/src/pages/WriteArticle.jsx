...
const WriteArticle = () => {
  const artileLength = [
    {
      length: 1400,
      text: "Short (800-1400 words)",
    },
    {
      length: 2000,
      text: "Medium (1000-2000 words)",
    },
    {
      length: 5000,
      text: "Long (2000+ words)",
    },
  ];

  const [selectedLength, setSelectedLength] = useState(artileLength[0]);
